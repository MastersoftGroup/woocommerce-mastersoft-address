...
if (
	...
	if( ! function_exists( 'load_mastersoft_address_scripts' ) ) {	
		...
		function load_mastersoft_address_scripts() {
			...
			wp_enqueue_script('harmony', 'https://common.mastersoftgroup.com/scripts/harmony-2.3.0.min.js');
			wp_enqueue_style('harmony', 'https://common.mastersoftgroup.com/scripts/harmony-2.3.0.css');
		}
	}	
